    ...
    const navItems = [
        ...
        },
        {
            ...
            links: [
                ...
                // { href: '/certifications',      label: 'Certifications',   icon: <BadgeIcon /> },
    ...
    return (
        <>
            ...
            <div className="flex min-h-screen bg-slate-50">
                ...
                ══════════════════════════════════════════ */}
                <aside className={`
                    fixed left-0 top-0 z-40 h-screen w-64 bg-slate-950 flex flex-col
                                            ...
                                            <li key={link.href}>
                                                <Link
                                                    ...
                                                    className={`
                                                        ...
                                                        ${'danger' in link && link.danger && !active
                    ...
                    <header className="sticky top-0 z-30 h-16 bg-white border-b border-slate-100 flex items-center justify-between px-6 lg:px-8 flex-shrink-0">
                        ...
                        <div className="flex items-center gap-2">
                            ...
                            <Link
                                ...
                                className="hidden md:inline-flex items-center gap-2 bg-emerald-600 hover:bg-emerald-700 text-white text-xs font-semibold px-4 py-2 rounded-xl transition-colors"
                            >
                            ...
                            <Link
                                href="/urgences"
                                className="relative w-9 h-9 rounded-xl bg-red-50 border border-red-100 flex items-center justify-center text-red-500 hover:bg-red-100 transition-all"
                            >
                            ...
                            {auth?.user && (
                                <div className="relative">
                                    <button
                                        ...
                                        className="flex items-center gap-2.5 rounded-xl border border-slate-200 bg-slate-50 px-3 py-2 hover:border-emerald-200 transition-all"
                                    >
                                        <div className="h-7 w-7 rounded-lg bg-emerald-700 flex items-center justify-center text-white text-xs font-black">
                                            {getInitials(auth.user.name)}
                                        </div>
                                        <span className="hidden md:block text-sm font-semibold text-slate-900">{auth.user.name}</span>
...
function BadgeIcon()      { return <svg className="h-4 w-4" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"><path d="M12 22s8-4 8-10V5l-8-3-8 3v7c0 6 8 10 8 10z"/></svg>; }
